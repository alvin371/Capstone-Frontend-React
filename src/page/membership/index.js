  ...
  return (
    <div>
      <div className="space-y-20">
        ...
        <div class="rounded-xl mx-10 sm:mb-10 lg:grid lg:grid-cols-5 md:grid-cols-none md:bg-gray bg-gray lg:bg-white lg:h-full">
          <div class=" px-10 py-10 max-w-md m-auto lg:col-span-2 mt-20 mb-20 shadow-xl rounded-xl lg:mt-10 md:shadow-xl md:rounded-xl lg:shadow-none lg:rounded-none lg:w-full lg:mb-10 lg:px-5 lg:pt-5 lg:pb-5 lg:max-w-lg bg-white">
            <img class="my-4 h-10" src={Logo} alt="Workcation logo" />
            <img
              class="h-64 sm:h-52 sm:w-full sm:object-cover lg:hidden object-center mt-2 rounded-lg shadow-2xl"
            ...
            <h1 class="mb-4 font-semibold text-lg text-red-dark">
              Get started today!
            </h1>
            <h1 class="text-md font-medium text-gray-dark text-justify pt-2">
              What you got
              
            </h1>
            <ol className="font-medium space-y-1">
              <li>1. Access to all class</li>
              <li>2. Make a class appointment</li>
              <li>3. And anything else</li>
            </ol>
            <button class="mt-5 bg-red p-3 shadow-2xl rounded-xl text-white font-bold hover:bg-red-dark">
              Get Membership
            </button>
          ...
          <div class="hidden relative lg:block  lg:col-span-3">
            <img
              class="absolute inset-0 w-full h-full xl:w-5/6 object-cover object-center"
              src="https://images.unsplash.com/photo-1574680088814-c9e8a10d8a4d?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1469&q=80"
              alt="Ad- woman on a beach"
            />
          </div>
